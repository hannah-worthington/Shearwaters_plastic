...
# restart at new values
opt_cococc <- nlm(likelihood_HMM, opt_cococc$estimate, model = model_cococc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_plastic) # repeat as needed
...
# Model 13
# logistic return on mass (shared intercept, shared slope), constant capture, constant retention
param_start_sscc2 <- c(0, 0, 0, 0)
model_sscc2 <- c('covariate_ss', 'constant', 'constant')
likelihood_HMM(param_start_sscc2, model = model_sscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)

opt_sscc2 <- nlm(likelihood_HMM, param_start_sscc2, model = model_sscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)
# restart at new values
opt_sscc2 <- nlm(likelihood_HMM, opt_sscc2$estimate, model = model_sscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)
res_sscc2 <- param_unpack(opt_sscc2$estimate, model = model_sscc2, n = n, occasions_i = occasions_i, covariate = cov_mass, res = T)
AIC_sscc2 <- 2*opt_sscc2$minimum + 2*length(opt_sscc2$estimate)

# Model 14
# logistic return on mass (shared intercept, shared slope), temporal capture, constant retention
param_start_sstc2 <- c(0, 0, rep(0, 5), 0)
model_sstc2 <- c('covariate_ss', 'time', 'constant')
likelihood_HMM(param_start_sstc2, model = model_sstc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)

opt_sstc2 <- nlm(likelihood_HMM, param_start_sstc2, model = model_sstc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)
# restart at new values
opt_sstc2 <- nlm(likelihood_HMM, opt_sstc2$estimate, model = model_sstc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_mass)
res_sstc2 <- param_unpack(opt_sstc2$estimate, model = model_sstc2, n = n, occasions_i = occasions_i, covariate = cov_mass, res = T)
AIC_sstc2 <- 2*opt_sstc2$minimum + 2*length(opt_sstc2$estimate)

# Model 15
# logistic return on mass (cohort intercept, shared slope), constant capture, constant retention
param_start_coscc2 <- c(rep(0, n_cohorts), 0, 0, 0)
model_coscc2 <- c('covariate_cos', 'constant', 'constant')
likelihood_HMM(param_start_coscc2, model = model_coscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_coscc2 <- nlm(likelihood_HMM, param_start_coscc2, model = model_coscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_coscc2 <- nlm(likelihood_HMM, opt_coscc2$estimate, model = model_coscc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
res_coscc2 <- param_unpack(opt_coscc2$estimate, model = model_coscc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
AIC_coscc2 <- 2*opt_coscc2$minimum + 2*length(opt_coscc2$estimate)

# Model 16
# logistic return on mass (cohort intercept, shared slope), temporal capture, constant retention
param_start_costc2 <- c(rep(0, n_cohorts), 0, rep(0, 5), 0)
model_costc2 <- c('covariate_cos', 'time', 'constant')
likelihood_HMM(param_start_costc2, model = model_costc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_costc2 <- nlm(likelihood_HMM, param_start_costc2, model = model_costc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_costc2 <- nlm(likelihood_HMM, opt_costc2$estimate, model = model_costc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass) 
# repeat as needed
res_costc2 <- param_unpack(opt_costc2$estimate, model = model_costc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
AIC_costc2 <- 2*opt_costc2$minimum + 2*length(opt_costc2$estimate)

# Model 17
# logistic return on mass (shared intercept, cohort slope), constant capture, constant retention
param_start_scocc2 <- c(0, rep(0, n_cohorts), 0, 0)
model_scocc2 <- c('covariate_sco', 'constant', 'constant')
likelihood_HMM(param_start_scocc2, model = model_scocc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_scocc2 <- nlm(likelihood_HMM, param_start_scocc2, model = model_scocc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_scocc2 <- nlm(likelihood_HMM, opt_scocc2$estimate, model = model_scocc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
res_scocc2 <- param_unpack(opt_scocc2$estimate, model = model_scocc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
AIC_scocc2 <- 2*opt_scocc2$minimum + 2*length(opt_scocc2$estimate)

# Model 18
# logistic return on mass (shared intercept, cohort slope), temporal capture, constant retention
param_start_scotc2 <- c(0, rep(0, n_cohorts), rep(0, 5), 0)
model_scotc2 <- c('covariate_sco', 'time', 'constant')
likelihood_HMM(param_start_scotc2, model = model_scotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_scotc2 <- nlm(likelihood_HMM, param_start_scotc2, model = model_scotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_scotc2 <- nlm(likelihood_HMM, opt_scotc2$estimate, model = model_scotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
res_scotc2 <- param_unpack(opt_scotc2$estimate, model = model_scotc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
AIC_scotc2 <- 2*opt_scotc2$minimum + 2*length(opt_scotc2$estimate)

# Model 19
# logistic return on mass (cohort intercept, cohort slope), constant capture, constant retention
param_start_cococc2 <- c(rep(0, n_cohorts), rep(0, n_cohorts), 0, 0)
model_cococc2 <- c('covariate_coco', 'constant', 'constant')
likelihood_HMM(param_start_cococc2, model = model_cococc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_cococc2 <- nlm(likelihood_HMM, param_start_cococc2, model = model_cococc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_cococc2 <- nlm(likelihood_HMM, opt_cococc2$estimate, model = model_cococc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
res_cococc2 <- param_unpack(opt_cococc2$estimate, model = model_cococc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
AIC_cococc2 <- 2*opt_cococc2$minimum + 2*length(opt_cococc2$estimate)

# Model 20
# logistic return on mass (cohort intercept, cohort slope), temporal capture, constant retention
param_start_cocotc2 <- c(rep(0, n_cohorts), rep(0, n_cohorts), rep(0, 5), 0)
model_cocotc2 <- c('covariate_coco', 'time', 'constant')
likelihood_HMM(param_start_cocotc2, model = model_cocotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)

opt_cocotc2 <- nlm(likelihood_HMM, param_start_cocotc2, model = model_cocotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass)
# restart at new values
opt_cocotc2 <- nlm(likelihood_HMM, opt_cocotc2$estimate, model = model_cocotc2, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass) 
# repeat as needed
res_cocotc2 <- param_unpack(opt_cocotc2$estimate, model = model_cocotc2, n = n, occasions_i = occasions_i, covariate = cov_cohort, covariate2 = cov_mass, res = T)
...
# Model 21
# logistic regression on plastic and mass (shared intercept, shared gradients), constant capture, constant retention
param_start_ssscc <- c(0, 0, 0, 0, 0)
model_ssscc <- c('covariate_sss', 'constant', 'constant')
likelihood_HMM(param_start_ssscc, model = model_ssscc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass)

opt_ssscc <- nlm(likelihood_HMM, param_start_ssscc, model = model_ssscc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass)
res_ssscc <- param_unpack(opt_ssscc$estimate, model = model_ssscc, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass, res = T)
AIC_ssscc <- 2*opt_ssscc$minimum + 2*length(opt_ssscc$estimate)

# Model 22
# logistic regression on plastic and mass (shared intercept, shared gradients), temporal capture, constant retention
param_start_ssstc <- c(0, 0, 0, rep(0, 5), 0)
model_ssstc <- c('covariate_sss', 'time', 'constant')
likelihood_HMM(param_start_ssstc, model = model_ssstc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass)

opt_ssstc <- nlm(likelihood_HMM, param_start_ssstc, model = model_ssstc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass)
# restart at new values
opt_ssstc <- nlm(likelihood_HMM, opt_ssstc$estimate, model = model_ssstc, histories_i = histories_i, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass)
res_ssstc <- param_unpack(opt_ssstc$estimate, model = model_ssstc, n = n, occasions_i = occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass, res = T)
...
# bootstrap for standard errors of three best models
nboot <- 999
# Model 2
boot_values_2 <- bootstrap_fn(nboot, opt_ctc$estimate, histories_i, model_ctc, n, occasions_i, stratify = cov_cohort)
SE_r_intercept_2 <- sd(boot_values_2$boot_intercept)
SE_p_2 <- apply(boot_values_2$boot_p, 2, sd)
SE_phi_2 <- sd(boot_values_2$boot_phi)

# Model 6
boot_values_6 <- bootstrap_fn(nboot, opt_sstc$estimate, histories_i, model_sstc, n, occasions_i, covariate = cov_plastic, stratify = cov_cohort)
...
# Model 22
boot_values_22 <- bootstrap_fn(nboot, opt_ssstc$estimate, histories_i, model_ssstc, n, occasions_i, covariate2 = cov_plastic, covariate3 = cov_mass, stratify = cov_cohort)
...
for (b in 1:nboot)  {
  ...
  for (p in 1:length(pred_plastic))  {
    # estimate r
    pred_boot_logitr[b, p] <- avg_r_intercept + avg_r_plastic*pred_plastic[p] + avg_r_mass*pred_mass
...
MLE_logitr <- MLE_avg_intercept + MLE_avg_plastic*pred_plastic + MLE_avg_mass*pred_mass
...
ggplot() +
  ...
  geom_line(aes(x = pred_plastic, y = MLE_r), colour = 'black', size = 1.25) +
  ...
  ylab("Estimated probability of return (r)") +
  guides(colour = 'none')
